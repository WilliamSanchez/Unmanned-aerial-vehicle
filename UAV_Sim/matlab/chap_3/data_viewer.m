    ...
    methods
        ...
        function self=update(self, true, estimated, commanded, Ts)
            if self.plot_initialized == 0
                ...
                subplot(4,4,3)
                    hold on
                    self.phi_handle = self.graph_y_yhat_yd(self.time, true.phi, estimated.phi, commanded.pn, [],'\phi');
                 subplot(4,4,4)
                    hold on
                ...
                subplot(4,4,15)
                    hold on
                    self.chi_handle = self.graph_y_yhat(self.time, true.chi, estimated.chi, [],'\chi');
                 subplot(4,4,16)
                    hold on
